    ...
    return (
        <div>
            ...
            <div className="max-[768px]:flex max-[768px]:justify-center ">
                <svg className="w-[45rem] h-[25rem] max-[768px]:w-[425px] max-[768px]:mt-[-50px]" viewBox="0 0 2493 1011">
            ...
            <div className="mt-[-60px] max-[768px]:mt-[-120px] max-[768px]:flex max-[768px]:flex-col max-[768px]:items-center flex flex-col items-center">
                <hr className="pb-1 " />
                <hr className="pb-1 w-[90%] " />
                <hr className="pb-1 w-[80%] " />
                <hr className="pb-1 w-[70%] " />
                <hr className="pb-1 w-[60%] " />
                <hr className="pb-1 w-[50%] " />
                <hr className="pb-1 w-[40%] " />
                <hr className="pb-1 w-[30%] " />
                <hr className="pb-1 w-[20%] " />
                <hr className="pb-1 w-[10%] " />
            </div>
        </div>
    )
}
